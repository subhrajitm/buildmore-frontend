...
import { Search, MapPin, ShoppingCart, ChevronDown, BarChart3, Sun, Moon, Award } from 'lucide-react';
        ...
        <div className="flex items-center gap-6">
          <Link to="/profile" className="flex flex-col cursor-pointer group text-right">
            ...
            <div className="flex items-center gap-1.5 justify-end">
              <span className={`text-[11px] font-black ${isDark ? 'text-white' : 'text-slate-900'}`}>BuildGlobal_Admin</span>
          ...
          <Link to="/cart" className="relative flex items-center gap-2 cursor-pointer group">
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <span className="text-[11px] font-black text-yellow-400">$12,450.00</span>
            </div>
          </Link>
        </div>
      </div>
